...
void binaryInputOutputTest()
{
	...
	Polynom P(degree, coefficients), P2;
	...
	cout << "binary input-output test:" << endl;
	cout << "Expected \t Actually" << endl;
	cout << "Degree:" << endl;
	cout << P.getDegree() << " \t\t " << P2.getDegree() << endl;
	cout << "Coefficients:" << endl;
	...
	//степени многочленов должны совпадать
	if (P2.getDegree() != P.getDegree())
		throw exception("Bad degree in binary input-output");

	//коэффициенты должны совпадать
	for (int i = 0; i < P.getDegree() + 1; i++)
		if (P2.getCoefficient(i) != P.getCoefficient(i))
			throw exception("Bad coefficients in binary input-output");
...
void fileInputOutputTest()
{
	...
	cout << "file input-output test:" << endl;
	cout << "Expected \t Actually" << endl;
	cout << "Degree:" << endl;
	cout << P.getDegree() << " \t\t " << P2.getDegree() << endl;
	cout << "Coefficients:" << endl;
	...
	//степени многочленов должны совпадать
	if (P2.getDegree() != P.getDegree())
		throw exception("Bad degree in file input-output");

	//коэффициенты должны совпадать
	for (int i = 0; i < P.getDegree() + 1; i++)
		if (P2.getCoefficient(i) != P.getCoefficient(i))
			throw exception("Bad coefficients in file input-output");
